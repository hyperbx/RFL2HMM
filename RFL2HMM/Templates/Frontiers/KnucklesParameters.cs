...
public class KnucklesParametersClass
{
    ...
    public struct KnucklesParamMaximumHeatKnuckle
    {
        ...
        [FieldOffset(0x10)] public float damageTime__arr0;
        [FieldOffset(0x14)] public float damageTime__arr1;
        [FieldOffset(0x18)] public float damageTime__arr2;
        [FieldOffset(0x1C)] public float damageTime__arr3;
    ...
    public struct KnucklesParameters
    {
