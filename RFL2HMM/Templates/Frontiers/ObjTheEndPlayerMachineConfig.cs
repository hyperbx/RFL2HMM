...
public class ObjTheEndPlayerMachineConfigClass
{
    ...
    [StructLayout(LayoutKind.Explicit, Size = 0x0C)]
    public struct TheEndConfig
    {
        [FieldOffset(0x00)] public float distance;
        [FieldOffset(0x04)] public float gageUpVolumeFromMiss;
        [FieldOffset(0x08)] public float hitViewScale;
    }

    [StructLayout(LayoutKind.Explicit, Size = 0xE0)]
    public struct ObjTheEndPlayerMachineConfig
    {
        ...
        [FieldOffset(0xD0)] public TheEndConfig TheEnd;
    }
