...
public class SonicParametersClass
{
    ...
    [StructLayout(LayoutKind.Explicit, Size = 0x8040)]
    public struct CommonPackageSonic
    {
        [FieldOffset(0)]     public CommonPackage commonPackage;
        [FieldOffset(0x4A10)] public PlayerParamAcceleComboSet acceleComboSet;
        [FieldOffset(0x4AD0)] public PlayerParamLoopKickSet loopKickSet;
        [FieldOffset(0x4B90)] public PlayerParamCrasherSet crasherSet;
        [FieldOffset(0x4D40)] public PlayerParamSpinSlashSet spinSlashSet;
        [FieldOffset(0x4FB0)] public PlayerParamChargeAttackSet chargeAtackSet;
        [FieldOffset(0x5190)] public PlayerParamStompingAttackSet stompingAttackSet;
        [FieldOffset(0x5400)] public PlayerParamComboFinishSet comboFinishSet;
        [FieldOffset(0x54C0)] public PlayerParamSonicBoomSet sonicboomSet;
        [FieldOffset(0x5580)] public PlayerParamCrossSlashSet crossSlashSet;
        [FieldOffset(0x5790)] public PlayerParamHomingShotSet homingShotSet;
        [FieldOffset(0x5940)] public PlayerParamSmashSet smashSet;
        [FieldOffset(0x5D60)] public PlayerParamBehind behind;
        [FieldOffset(0x5D74)] public PlayerParamCombo combo;
        [FieldOffset(0x6058)] public PlayerParamCyloop cyloop;
        [FieldOffset(0x74C0)] public PlayerParamSuperSonic supersonic;
        [FieldOffset(0x7EE0)] public PlayerParamSandSki sandski;
        [FieldOffset(0x7F10)] public PlayerParamSlingshot slingshot;
        [FieldOffset(0x7F70)] public PlayerParamRunawayBee runawayBee;
        [FieldOffset(0x7F84)] public PlayerParamRunWithKodama runWithKodama;
        [FieldOffset(0x802C)] public PlayerParamMine mine;
    }
    ...
    [StructLayout(LayoutKind.Explicit, Size = 0xAE90)]
    public struct SonicParameters
    {
        [FieldOffset(0x00)] public CommonPackageSonic common;
        [FieldOffset(0x8040)] public ModePackageSonic forwardView;
        [FieldOffset(0x8F20)] public WaterModePackage water;
        [FieldOffset(0x90D0)] public ModePackageSonic cyberspace;
        [FieldOffset(0x9FB0)] public ModePackageSonic cyberspaceSV;
    }
