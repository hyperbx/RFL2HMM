...
public class TailsParametersClass
{
    ...
    public struct CommonPackageTails
    {
        ...
        [FieldOffset(0x4CF0)] public TailsParamParryDebuff parryDebuff;
        [FieldOffset(0x4CF8)] public PlayerParamCyloop cyloop;
    }
    ...
    public struct TailsParamFlyRise
    {
        ...
        [FieldOffset(0x14)] public float heightRatio__arr0;
        [FieldOffset(0x18)] public float heightRatio__arr1;
        [FieldOffset(0x1C)] public float heightRatio__arr2;
        [FieldOffset(0x20)] public float heightRatio__arr3;
    }
    ...
    [StructLayout(LayoutKind.Explicit, Size = 0x7C70)]
    public struct TailsParameters
    {
        [FieldOffset(0x00)] public CommonPackageTails common;
        [FieldOffset(0x6160)] public ModePackageTails forwardView;
        [FieldOffset(0x6E10)] public WaterModePackage water;
        [FieldOffset(0x6FC0)] public ModePackageTails cyberspaceSV;
    }
