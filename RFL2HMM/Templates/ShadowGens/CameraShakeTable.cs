Library "CameraShakeTable"
{
    ...
    public struct CameraShakeTable
    {
        ...
        [FieldOffset(0xC00)] public CameraShakeRecord records__arr64;
        [FieldOffset(0xC30)] public CameraShakeRecord records__arr65;
        [FieldOffset(0xC60)] public CameraShakeRecord records__arr66;
        [FieldOffset(0xC90)] public CameraShakeRecord records__arr67;
        [FieldOffset(0xCC0)] public CameraShakeRecord records__arr68;
        [FieldOffset(0xCF0)] public CameraShakeRecord records__arr69;
        [FieldOffset(0xD20)] public CameraShakeRecord records__arr70;
        [FieldOffset(0xD50)] public CameraShakeRecord records__arr71;
        [FieldOffset(0xD80)] public CameraShakeRecord records__arr72;
        [FieldOffset(0xDB0)] public CameraShakeRecord records__arr73;
        [FieldOffset(0xDE0)] public EventCameraShakeRecord eventRecords__arr0;
        [FieldOffset(0xE00)] public EventCameraShakeRecord eventRecords__arr1;
        [FieldOffset(0xE20)] public EventCameraShakeRecord eventRecords__arr2;
        [FieldOffset(0xE40)] public EventCameraShakeRecord eventRecords__arr3;
        [FieldOffset(0xE60)] public EventCameraShakeRecord eventRecords__arr4;
        [FieldOffset(0xE80)] public EventCameraShakeRecord eventRecords__arr5;
        [FieldOffset(0xEA0)] public EventCameraShakeRecord eventRecords__arr6;
        [FieldOffset(0xEC0)] public EventCameraShakeRecord eventRecords__arr7;
    }
