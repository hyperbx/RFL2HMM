Library "EnemyBeetleConfig"
{
    ...
    public struct EnemyBeetleCommonConfig
    {
    ...
    [StructLayout(LayoutKind.Explicit, Size = 0x80)]
    public struct EnemyBeetleConfig
    {
        [FieldOffset(0x00)] public EnemyBeetleCommonConfig commonParams;
    }
