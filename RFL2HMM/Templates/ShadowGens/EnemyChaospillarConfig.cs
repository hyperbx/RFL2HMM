Library "EnemyChaospillarConfig"
{
    ...
    public struct EnemyChaospillarCommon
    {
        ...
        [FieldOffset(0x70)] public EnemyCollisionParam collisionParamBody;
        [FieldOffset(0xD0)] public EnemyComboParam comboParam;
    }

    [StructLayout(LayoutKind.Explicit, Size = 0xE0)]
    public struct EnemyChaospillarConfig
    {
        [FieldOffset(0x00)] public EnemyChaospillarCommon commonParams;
    }
